...
declare global {
  interface Window {
    chatbase?: {
      (arg: string, ...args: any[]): any;
      q?: any[];
    };
  }
}

const ChatbaseIntegrationUpdated = () => {
  const [isOpen, setIsOpen] = useState(true); // State to track chat bubble visibility
...
export default ChatbaseIntegrationUpdated;
